function varargout = BAI1_671660_DOPHUONGMANH(varargin)
% BAI1_671660_DOPHUONGMANH MATLAB code for BAI1_671660_DOPHUONGMANH.fig
%      BAI1_671660_DOPHUONGMANH, by itself, creates a new BAI1_671660_DOPHUONGMANH or raises the existing
%      singleton*.
%
%      H = BAI1_671660_DOPHUONGMANH returns the handle to a new BAI1_671660_DOPHUONGMANH or the handle to
%      the existing singleton*.
%
%      BAI1_671660_DOPHUONGMANH('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BAI1_671660_DOPHUONGMANH.M with the given input arguments.
%
%      BAI1_671660_DOPHUONGMANH('Property','Value',...) creates a new BAI1_671660_DOPHUONGMANH or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before BAI1_671660_DOPHUONGMANH_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to BAI1_671660_DOPHUONGMANH_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help BAI1_671660_DOPHUONGMANH

% Last Modified by GUIDE v2.5 27-Sep-2024 08:20:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @BAI1_671660_DOPHUONGMANH_OpeningFcn, ...
                   'gui_OutputFcn',  @BAI1_671660_DOPHUONGMANH_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before BAI1_671660_DOPHUONGMANH is made visible.
function BAI1_671660_DOPHUONGMANH_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to BAI1_671660_DOPHUONGMANH (see VARARGIN)

% Choose default command line output for BAI1_671660_DOPHUONGMANH
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes BAI1_671660_DOPHUONGMANH wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = BAI1_671660_DOPHUONGMANH_OutputFcn(hObject, eventdata, handles) 
